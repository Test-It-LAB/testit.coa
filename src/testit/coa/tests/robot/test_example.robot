...
#
#  $ bin/test -s testit.coa -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src testit.coa.testing.TESTIT_COA_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/testit/coa/tests/robot/test_example.robot
#
